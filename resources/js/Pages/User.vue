    ...
    <MainLayout>
        ...
        <div class="max-w-[880px] lg:ml-0 md:ml-[80px] md:pl-20 px-4 w-[100vh]">
            <div class="flex items-center md:justify-between">
                <label for="fileUser">
                    <img class="rounded-full object-fit md:w-[200px] w-[100px] cursor-pointer" src="https://picsum.photos/id/50/200/200" >
                </label>
                <input 
                    id="fileUser"
                    class="hidden"
                ...
                <div class="ml-6 w-full">
                    <div class="flex items-center md:mb-4 mb-5">
                        ...
                        <button class="md:block hidden md:mr-8 p-1 px-4 rounded-lg text-[16px] font-extrabold bg-gray-100 hover:bg-gray-200">
                            Edit Profile
                        </button>
        ...
        <div class="md:hidden">
            <div class="w-full flex items-center justify-around border-t border-t-gray-300 mt-8">
                ...
                <div class="text-center p-3">
                    <div class="font-extrabold">34</div>
